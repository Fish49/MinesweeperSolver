...
def viewProfile():
    ...
    def showProfile():
        ...
        originPointLabel = ttk.Label(showProfileWindow, text='')
        boardWidthLabel = ttk.Label(showProfileWindow, text='')
        boardHeightLabel = ttk.Label(showProfileWindow, text='')
        squareSizeLabel = ttk.Label(showProfileWindow, text='')
        defatultOffsetLabel = ttk.Label(showProfileWindow, text='')
        blueSpaceLabel = ttk.Label(showProfileWindow, text='')
        minSimilarityLabel = ttk.Label(showProfileWindow, text='')
